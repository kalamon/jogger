...
public class GoToZeroOperation extends AbstractGCodeOperationWithResult {
    private static final String TAG = GoToZeroOperation.class.getName();

    public GoToZeroOperation(Context context, NetworkFragment networkFragment, Machine machine) {
